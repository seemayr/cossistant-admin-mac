...
enum DashboardTimelineItemVisibility: String, Decodable, Hashable, Sendable {
  case `public`
  case `private`
...
enum DashboardTimelineItemType: String, Decodable, Hashable, Sendable {
  case message
  case event
  case identification
  case tool
...
enum DashboardToolTimelineLogType: String, Decodable, Hashable, Sendable {
...
struct DashboardTimelineTextPart: Decodable, Hashable, Sendable {
  let type: String
  let text: String
  let state: String?
}

struct DashboardTimelineReasoningPart: Decodable, Hashable, Sendable {
  let type: String
  let text: String
  let state: String?
}

struct DashboardTimelineSourceURLPart: Decodable, Hashable, Sendable {
  let type: String
  let sourceId: String
  let url: String
  let title: String?
...
struct DashboardTimelineSourceDocumentPart: Decodable, Hashable, Sendable {
  let type: String
  let sourceId: String
...
struct DashboardTimelineFilePart: Decodable, Hashable, Sendable {
  let type: String
  let url: String
  let mediaType: String
  let filename: String?
...
struct DashboardTimelineImagePart: Decodable, Hashable, Sendable {
  let type: String
  let url: String
  let mediaType: String
  let filename: String?
...
struct DashboardTimelineEventPart: Decodable, Hashable, Sendable {
  let type: String
...
struct DashboardTimelineMetadataPart: Decodable, Hashable, Sendable {
  let type: String
  let source: String
}

struct DashboardTimelineToolPart: Decodable, Hashable, Sendable {
  let type: String
...
struct DashboardTimelineProviderMetadata: Decodable, Hashable, Sendable {
  let cossistant: DashboardTimelineCossistantMetadata?
}

struct DashboardTimelineCossistantMetadata: Decodable, Hashable, Sendable {
  let visibility: DashboardTimelineItemVisibility?
...
struct DashboardTimelineToolMetadata: Decodable, Hashable, Sendable {
